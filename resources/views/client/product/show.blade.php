                                                    ...
                                                    <div class="wpb_wrapper">
                                                        <div class="wpb_single_image wpb_content_element vc_align_left">
                                                            <figure class="wpb_wrapper vc_figure">
                                                                <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="540" height="460" src="/client/images/megamenu-2.png" class="vc_single_image-img attachment-full" alt="megamenu-2"/></div>
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div id="content" class="site-content" tabindex="-1">
        <div class="container">
            ...
            <nav class="woocommerce-breadcrumb">
                ...
                <span class="delimiter"><i class="fa fa-angle-right"></i></span>
                <a href="product-category.html">{{$product->brand->name}}</a>
                            ...
                            <div class="product-images-wrapper">
                                ...
                                <div class="images electro-gallery">
                                    <div class="thumbnails-single owl-carousel">
                                        <a  class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img  src="{{str_replace('public','/storage',$product->image)}}" data-echo="{{str_replace('public','/storage',$product->image)}}" class="wp-post-image" alt=""></a>

                                    </div><!-- .thumbnails-single -->

                                    <div class="thumbnails-all columns-5 owl-carousel">

                                        <a href="images/single-product/single-thumb1.jpg" class="first" title=""><img src="{{str_replace('public','/storage',$product->image)}}" data-echo="{{str_replace('public','/storage',$product->image)}}" class="wp-post-image" alt=""></a>
                                        @foreach($product->pictures as $picture)
                                        <a href="images/single-product/single-thumb1.jpg" class="first" title=""><img src="{{str_replace('public','/storage',$picture->path)}}" data-echo="{{str_replace('public','/storage',$picture->path)}}" class="wp-post-image" alt=""></a>
                                        @endforeach
                                    </div><!-- .thumbnails-all -->
                                </div><!-- .electro-gallery -->
                            ...
                            <div class="summary entry-summary">
                                ...
                                <div class="brand">
                                    <a href="product-category.html">
                                        <img src="/client/images/single-product/brand.png" alt="Gionee" />
                                    </a>
                                </div><!-- .brand -->
                                ...
                                <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                    ...
                                    <p class="price"><span class="electro-price"><ins><span class="amount">&#36;{{$product->cost}}</span></ins> <del><span class="amount">&#36;{{$product->cost}}</span></del></span></p>
                                    ...
                                    <div class="electro-description">
                                        ...
                                        <table class="layout">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="alignright" data-echo="/client/images/single-product/ForDescription.jpg" src="/client/images/blank.gif" alt="">
                                        ...
                                        <table class="layout">
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="alignnone" data-echo="/client/images/single-product/ForDescription-1.png" src="/client/images/blank.gif" alt="">
                                                </td>
                                            ...
                                            <ol class="commentlist">
                                                <li itemprop="review" class="comment even thread-even depth-1">
                                                    ...
                                                    <div id="comment-390" class="comment_container">
                                                        ...
                                                        <img alt='' src="/client/images/blog/avatar.jpg" class="avatar" height='60' width='60' />
...
<script type="text/javascript" src="/client/js/electro.js/electro.min.js"></script>
