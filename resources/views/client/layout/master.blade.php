...
<head>
    ...
    <title>Erfan shop</title>

    <link rel="stylesheet" type="text/css" href="/client/css/bootstrap.min.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/client/css/font-awesome.min.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/client/css/animate.min.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/client/css/font-electro.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/client/css/owl-carousel.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/client/css/style.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/client/css/colors/yellow.css" media="all" />

    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700,700italic,800,800italic,600italic,400italic,300italic' rel='stylesheet' type='text/css'>

    <link rel="shortcut icon" href="/client/images/fav-icon.png">
</head>
...
<div id="page" class="hfeed site">
                                    ...
                                    <ul class="cart_list product_list_widget ">
                                        ...
                                        <li class="mini_cart_item">
                                            ...
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="/client/images/products/mini-cart1.jpg" alt="">White lumia 9001&nbsp;
                                            </a>
                                        ...
                                        <li class="mini_cart_item">
                                            <a title="Remove this item" class="remove" href="#">×</a>
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="/client/images/products/mini-cart2.jpg" alt="">PlayStation 4&nbsp;
                                            </a>
                                        ...
                                        <li class="mini_cart_item">
                                            ...
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="/client/images/products/mini-cart3.jpg" alt="">POV Action Cam HDR-AS100V&nbsp;
                                                            ...
                                                            <div class="wpb_single_image wpb_content_element vc_align_left">
                                                                <figure class="wpb_wrapper vc_figure">
                                                                    <div class="vc_single_image-wrapper vc_box_border_grey">
                                                                        ...
                                                                        <img src="/client/images/megamenu-2.png" class="vc_single_image-img attachment-full" alt="">
                                                                    </div>
                                                                </figure>
                                                            </div>
                                                        </div>
                ...
                <main id="main" class="site-main">
                    <div class="home-v1-slider" >
                        ...
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            ...
                            <div class="item" style="background-image: url(/client/images/slider/banner-2.jpg);">
                                <div class="container">
                                    <div class="row">
                            ...
                            <div class="item" style="background-image: url(/client/images/slider/banner-1.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                            ...
                            <div class="item" style="background-image: url(/client/images/slider/banner-3.jpg);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-5">
                                            <div class="caption vertical-center text-left">
                    ...
                    <div class="home-v1-ads-block animate-in-view fadeIn animated" data-animation="fadeIn">
                        <div class="ads-block row">
                            <div class="ad col-xs-12 col-sm-4">
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <img data-echo="/client/images/banner/cameras.jpg" src="/client/images/blank.gif" alt="">
                                    </div>
                            ...
                            <div class="ad col-xs-12 col-sm-4">
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <img data-echo="/client/images/banner/MobileDevicesv2-2.jpg" src="/client/images/blank.gif" alt="">
                                    </div>
                                    <div class="media-body media-middle">
                                        <div class="ad-text">
                            ...
                            <div class="ad col-xs-12 col-sm-4">
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <img data-echo="/client/images/banner/DesktopPC.jpg" src="/client/images/blank.gif" alt="">
                                    </div>
                                    <div class="media-body media-middle">
                                        <div class="ad-text">
                                    ...
                                    <div class="onsale-product">
                                        <a href="shop.html">
                                            <div class="product-thumbnail">
                                                <img class="wp-post-image" data-echo="/client/images/onsale-product.jpg" src="/client/images/blank.gif" alt=""></div>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="/client/images/blank.gif" data-echo="/client/images/products/1.jpg" class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="/client/images/blank.gif" data-echo="/client/images/products/2.jpg" class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="/client/images/blank.gif" data-echo="/client/images/products/3.jpg" class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="/client/images/blank.gif" data-echo="/client/images/products/4.jpg" class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="/client/images/blank.gif" data-echo="/client/images/products/5.jpg" class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="product-outer">
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    <img src="/client/images/blank.gif" data-echo="/client/images/products/6.jpg" class="img-responsive" alt="">
                                                                </div>
                                                            </a>
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="/client/images/products/3.jpg" src="/client/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="/client/images/products/5.jpg" src="/client/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="/client/images/products/4.jpg" src="/client/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="/client/images/products/1.jpg" src="/client/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="/client/images/products/6.jpg" src="/client/images/blank.gif" alt="">
                                                        ...
                                                        <div class="product-inner">
                                                            ...
                                                            <a href="single-product.html">
                                                                ...
                                                                <div class="product-thumbnail">
                                                                    ...
                                                                    <img data-echo="/client/images/products/2.jpg" src="/client/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="/client/images/product-2-1-2/1.jpg" src="/client/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img data-echo="/client/images/product-2-1-2/4.jpg" src="/client/images/blank.gif" alt="">
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                                    <div class="product-thumbnail">
                                                        <img class="wp-post-image" data-echo="/client/images/product-2-1-2/main.jpg" src="/client/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img class="wp-post-image" data-echo="/client/images/product-2-1-2/1.jpg" src="/client/images/blank.gif" alt="">
                                            ...
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <img class="wp-post-image" data-echo="/client/images/product-2-1-2/4.jpg" src="/client/images/blank.gif" alt="">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="media-object wp-post-image img-responsive" src="/client/images/blank.gif" data-echo="/client/images/product-cards/4.jpg" alt="">
                                                </a>
                                    ...
                                    <li class="product product-card ">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="media-object wp-post-image img-responsive" src="/client/images/blank.gif" data-echo="/client/images/product-cards/6.jpg" alt="">
                                                </a>
                                    ...
                                    <li class="product product-card last">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="media-object wp-post-image img-responsive" src="/client/images/blank.gif" data-echo="/client/images/product-cards/5.jpg" alt="">
                                                </a>
                                    ...
                                    <li class="product product-card first">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image" src="/client/images/blank.gif" data-echo="/client/images/product-cards/1.jpg" alt="">
                                    ...
                                    <li class="product product-card ">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image" src="/client/images/blank.gif" data-echo="/client/images/product-cards/3.jpg" alt="">
                                                </a>
                                    ...
                                    <li class="product product-card last">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image" src="/client/images/blank.gif" data-echo="/client/images/product-cards/2.jpg" alt="">
                                                </a>
                                    ...
                                    <li class="product product-card ">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image" src="/client/images/blank.gif" data-echo="/client/images/product-cards/5.jpg" alt="">
                                                </a>
                                    ...
                                    <li class="product product-card last">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image" src="/client/images/blank.gif" data-echo="/client/images/product-cards/4.jpg" alt="">
                                                </a>
                                    ...
                                    <li class="product product-card ">
                                        ...
                                        <div class="product-outer">
                                            <div class="media product-inner">
                                                ...
                                                <a class="media-left" href="single-product.html" title="Pendrive USB 3.0 Flash 64 GB">
                                                    <img class="img-responsive media-object wp-post-image" src="/client/images/blank.gif" data-echo="/client/images/product-cards/6.jpg" alt="">
                                                </a>
                    ...
                    <div class="home-v1-banner-block animate-in-view fadeIn animated" data-animation="fadeIn">
                        <div class="home-v1-fullbanner-ad fullbanner-ad" style="margin-bottom: 70px">
                            <a href="#"><img src="/client/images/blank.gif" data-echo="/client/images/banner/home-v1-banner.png" class="img-responsive" alt=""></a>
                        </div>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    <h3>Tablet Thin EliteBook  Revolve 810 G6</h3>
                                                    <div class="product-thumbnail">
                                                        <img src="/client/images/blank.gif" data-echo="/client/images/product-category/2.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="/client/images/blank.gif" data-echo="/client/images/product-category/3.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    <h3>Notebook Black Spire V Nitro  VN7-591G</h3>
                                                    <div class="product-thumbnail">
                                                        <img src="/client/images/blank.gif" data-echo="/client/images/product-category/1.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="/client/images/blank.gif" data-echo="/client/images/product-category/5.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    <h3>Notebook Purple G952VX-T7008T</h3>
                                                    <div class="product-thumbnail">
                                                        <img src="/client/images/blank.gif" data-echo="/client/images/product-category/4.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                                        ...
                                        <div class="product-outer">
                                            <div class="product-inner">
                                                ...
                                                <a href="single-product.html">
                                                    ...
                                                    <div class="product-thumbnail">
                                                        <img src="/client/images/blank.gif" data-echo="/client/images/product-category/6.jpg" class="img-responsive" alt="">
                                                    </div>
                                                </a>
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="/client/images/blank.gif" data-echo="/client/images/brands/1.png" class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="/client/images/blank.gif" data-echo="/client/images/brands/2.png" class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="/client/images/blank.gif" data-echo="/client/images/brands/3.png" class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="/client/images/blank.gif" data-echo="/client/images/brands/4.png" class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="/client/images/blank.gif" data-echo="/client/images/brands/5.png" class="img-responsive" alt="">
                ...
                <div class="item">
                    ...
                    <a href="#">
                        ...
                        <figure>
                            ...
                            <img src="/client/images/blank.gif" data-echo="/client/images/brands/6.png" class="img-responsive" alt="">
    ...
    <footer id="colophon" class="site-footer">
                                ...
                                <ul class="product_list_widget">
                                    <li>
                                        <a href="single-product.html" title="Tablet Thin EliteBook  Revolve 810 G6">
                                            <img class="wp-post-image" data-echo="/client/images/footer/1.jpg" src="/client/images/blank.gif" alt="">
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Smartphone 6S 128GB LTE">
                                            <img class="wp-post-image" data-echo="/client/images/footer/2.jpg" src="/client/images/blank.gif" alt=""><span class="product-title">Smartphone 6S 128GB LTE</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Smartphone 6S 64GB LTE">
                                            <img class="wp-post-image" data-echo="/client/images/footer/3.jpg" src="/client/images/blank.gif" alt="">
                                ...
                                <ul class="product_list_widget">
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Tablet Red EliteBook  Revolve 810 G2">
                                            <img class="wp-post-image" data-echo="/client/images/footer/4.jpg" src="/client/images/blank.gif" alt="">
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Widescreen 4K SUHD TV">
                                            <img class="wp-post-image" data-echo="/client/images/footer/5.jpg" src="/client/images/blank.gif" alt="">
                        ...
                        <aside class="widget clearfix">
                            <div class="body">
                                ...
                                <ul class="product_list_widget">
                                    <li>
                                        <a href="single-product.html" title="Notebook Black Spire V Nitro  VN7-591G">
                                            <img class="wp-post-image" data-echo="/client/images/footer/6.jpg" src="/client/images/blank.gif" alt="">
                                            <span class="product-title">Notebook Black Spire V Nitro  VN7-591G</span>
                                        </a>
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Apple MacBook Pro MF841HN/A 13-inch Laptop">
                                            <img class="wp-post-image" data-echo="/client/images/footer/7.jpg" src="/client/images/blank.gif" alt="">
                                    ...
                                    <li>
                                        <a href="single-product.html" title="Tablet White EliteBook Revolve  810 G2">
                                            <img class="wp-post-image" data-echo="/client/images/footer/2.jpg" src="/client/images/blank.gif" alt="">
        ...
        <div class="copyright-bar">
            <div class="container">
                <div class="pull-left flip copyright">&copy; <a href="http://bteq.ir">Bteq</a> - All Rights Reserved</div>
                <div class="pull-right flip payment">
                    <div class="footer-payment-logo">
                        <ul class="cash-card card-inline">
                            <li class="card-item"><img src="/client/images/footer/payment-icon/1.png" alt="" width="52"></li>
                            <li class="card-item"><img src="/client/images/footer/payment-icon/2.png" alt="" width="52"></li>
                            <li class="card-item"><img src="/client/images/footer/payment-icon/3.png" alt="" width="52"></li>
                            <li class="card-item"><img src="/client/images/footer/payment-icon/4.png" alt="" width="52"></li>
                            <li class="card-item"><img src="/client/images/footer/payment-icon/5.png" alt="" width="52"></li>
                        </ul>
                    </div><!-- /.payment-methods -->
                </div>
            </div><!-- /.container -->
...
<script type="text/javascript" src="/client/js/tether.min.js"></script>
<script type="text/javascript" src="/client/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/client/js/bootstrap-hover-dropdown.min.js"></script>
<script type="text/javascript" src="/client/js/owl.carousel.min.js"></script>
<script type="text/javascript" src="/client/js/echo.min.js"></script>
...
<script type="text/javascript" src="/client/js/electro.js"></script>
