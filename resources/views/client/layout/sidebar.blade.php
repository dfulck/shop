                    ...
                    <nav>
                        <ul id="menu-main-menu" class="nav nav-inline yamm">
                            ...
                            <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Pages" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">category</a>
                                <ul role="menu" class=" dropdown-menu">
                                                                ...
                                                                <div class="widget widget_nav_menu">
                                                                    <div class="menu-pages-menu-1-container">
                                                                        <ul id="menu-pages-menu-1" class="menu">
                                                                            <li class="nav-title menu-item"><a href="{{route('categories.show',$category)}}">{{$category->title}}</a></li>
                                                                            @foreach($category->childiren as $cat)
                                                                            <li class=" nav-title menu-item"><a href="{{route('categories.show',$cat)}}">{{$cat->title}}</a></li>
@foreach($cat->childiren as $categ)
                                                                                <li class="menu-item"><a href="{{route('categories.show',$categ)}}">{{$categ->title}}</a></li>
                                                                                @endforeach
                                                                            @endforeach
                                                                        </ul>
                                                                    </div>
...
{{--                            brand--}}
                            <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Pages" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">brands</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown">
                                        <div class="yamm-content" style="display:inline-block; width: 100%;">
                                            <div class="row">
                                                            ...
                                                            <div class="wpb_wrapper">
                                                                <div class="vc_wp_custommenu wpb_content_element">
                                                                    <div class="widget widget_nav_menu">
                                                                        <div class="menu-pages-menu-1-container">
                                                                            <ul id="menu-pages-menu-1" class="menu">
                                                                                <li class="nav-title menu-item"><a href="{{route('brands.show',$brand)}}">{{$brand->name}}</a></li>

                                                                                <li class="menu-item"><img width="100" src="{{str_replace('public','storage',$brand->image)}}" alt="">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
