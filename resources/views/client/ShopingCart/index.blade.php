            ...
            <div class="row">
                ...
                <div id="content" class="col-sm-12">
                                ...
                                <tr class="cart-row-{{$product->id}}">
                                    ...
                                    <td class="text-left">
                                        <div class="input-group btn-block quantity">
                                            <input type="text" name="quantity" value="{{$productQty}}"  id="input-quantity-{{$product->id}}" class="form-control" />
                    ...
                    <div class="buttons">
                        ...
                        <div class="pull-right"><a href="{{route('Orders.create')}}" class="btn btn-primary">تسویه حساب</a></div>
                    </div>
                </div>
                <!--Middle Part End -->
            </div>
